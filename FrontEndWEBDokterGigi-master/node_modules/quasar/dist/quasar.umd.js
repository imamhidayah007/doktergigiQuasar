  ...
  */
  ...
  var QField = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        return ( obj = {}, obj[this.fieldClass] = this.fieldClass !== void 0, obj[("q-field--" + (this.styleType))] = true, obj['q-field--rounded'] =  this.rounded, obj['q-field--square'] =  this.square, obj['q-field--focused'] =  this.focused === true || this.hasError === true, obj['q-field--float'] =  this.floatingLabel, obj['q-field--labeled'] =  this.label !== void 0, obj['q-field--dense'] =  this.dense, obj['q-field--item-aligned q-item-type'] =  this.itemAligned, obj['q-field--dark'] =  this.dark, obj['q-field--auto-height'] =  this.__getControl === void 0, obj['q-field--with-bottom'] =  this.hideBottomSpace !== true && this.hasBottom === true, obj['q-field--error'] =  this.hasError, obj['q-field--readonly'] =  this.readonly, obj['q-field--disabled'] =  this.disable, obj )
      },
  ...
  var QSelect = Vue.extend({
    ...
    methods: {
      ...
      __getControlEvents: function __getControlEvents () {
        ...
        return {
          ...
          click: function (e) {
            ...
            if (this$1.$listeners.filter !== void 0) {
              this$1.filter(this$1.inputValue);
            }
            else if (this$1.noOptions !== true || this$1.$scopedSlots['no-option'] !== void 0) {
              this$1.menu = true;
            }
          }
        }
      ...
      __closePopup: function __closePopup () {
        this.dialog = false;
        this.__closeMenu();
      },
